...
namespace ghost
{
	...
	protected:
		...
		CONSTRAINT_VECTOR constraints; //!< The vector of shared pointers of each constraint composing the problem instance.
		OBJECTIVE_T objective; //!< The shared pointer of the objective function of the problem instance. Is set to nullptr is declare_objective() is not overriden.
		AUX_DATA_T auxiliary_data; //!< The shared pointer of the auxiliary data of the problem instance. Is set to nullptr is declare_auxiliary_data() is not overriden.
